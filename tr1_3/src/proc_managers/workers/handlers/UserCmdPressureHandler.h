...
class UserCmdPressureHandler : public IUserCmdHandler {
public:
    UserCmdPressureHandler(ipc::IIpc& ipc, helpers::FixedDataContainer<WeatherData>& weatherDatas);
    ~UserCmdPressureHandler() = default;
